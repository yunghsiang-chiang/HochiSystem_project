...
using MySql.Data.MySqlClient; // 引入 MySQL 套件
...
public partial class MySQLdatabase
{
    ...
    static public string ConnectionString
    {
        get
        {
            return System.Configuration.ConfigurationManager.ConnectionStrings["HochiEIPConnection"].ConnectionString;
        }
    }
    ...
    static private MySqlCommand CreateCommand(MySqlConnection conn, MySqlTransaction trans, string text, params object[] args)
    {
    ...
    static public MySqlCommand CreateCommand(MySqlConnection conn, string text, params object[] args)
    {
        if (conn == null) throw (new ArgumentNullException("conn"));
        if (text == null) throw (new ArgumentNullException("text"));
        return CreateCommand(conn, null, text, args);
    }
    static public MySqlCommand CreateCommand(MySqlTransaction trans, string text, params object[] args)
    {
    ...
    static public MySqlDataReader ExecuteReader(string text, params object[] args)
    {
        if (text == null) throw (new ArgumentNullException("text"));
        MySqlConnection conn = CreateConnection();
        MySqlCommand cmd = CreateCommand(conn, text, args);
        conn.Open();
    ...
    {
        using (MySqlDataReader reader = ExecuteReader(text, args))
        {
    ...
    static public MySqlDataReader ExecuteReader(MySqlTransaction trans, string text, params object[] args)
    {
        if (text == null) throw (new ArgumentNullException("text"));
        MySqlCommand cmd = CreateCommand(trans, text, args);
        return cmd.ExecuteReader();
    }
    static public void ExecuteNonQuery(MySqlTransaction trans, string text, params object[] args)
    {
        if (text == null) throw (new ArgumentNullException("text"));
        MySqlCommand cmd = CreateCommand(trans, text, args);
        cmd.ExecuteNonQuery();
    }
    static public object ExecuteScalar(MySqlTransaction trans, string text, params object[] args)
    {
        if (text == null) throw (new ArgumentNullException("text"));
        MySqlCommand cmd = CreateCommand(trans, text, args);
        return cmd.ExecuteScalar();
    ...
    static public int ExecuteInt32(MySqlTransaction trans, string text, params object[] args)
    {
        return Convert.ToInt32(ExecuteScalar(trans, text, args));
    }
    static public string ExecuteString(MySqlTransaction trans, string text, params object[] args)
    {
    ...
    static public DataTable ExecuteDataTable(MySqlTransaction trans, string text, params object[] args)
    {
        using (MySqlDataReader reader = ExecuteReader(trans, text, args))
        {
            DataTable table = new DataTable();
            table.Load(reader);
            return table;
    ...
    static public DataRow ExecuteDataRow(MySqlTransaction trans, string text, params object[] args)
    {
        return GetDataRow(ExecuteDataTable(trans, text, args), false);
    }
    static public DataRow ExecuteDataRow(MySqlTransaction trans, bool checkOnlyOne, string text, params object[] args)
    {
