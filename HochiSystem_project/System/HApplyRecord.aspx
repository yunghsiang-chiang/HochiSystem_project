<%@ Page Title="" Language="C#" MasterPageFile="~/System/Hochisystem.master" AutoEventWireup="true" CodeFile="HApplyRecord.aspx.cs" Inherits="System_HApplyRecord" %>
			...
			<div class="block-header">
				<div class="row">
					<div class="col-lg-3 col-md-12 col-sm-4">
						<h2><a onclick="history.back(-1)" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>單一課程參班紀錄分析</h2>
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="#"><i class="icon-home"></i></a></li>
							<li class="breadcrumb-item active">單一課程參班紀錄分析</li>
						</ul>
					</div>
				</div>
			</div>
							...
							<div class="row">
								<div class="col-md-12 col-lg-12 col-xlg-12">
									<div class="box form-group row m-b-0">
										...
										<div class="col-md-2">
											<asp:ListBox ID="LBox_HOCPlace" runat="server" class="form-control ListB_Multi" name="state" SelectionMode="Multiple" Width="100%"></asp:ListBox>
										</div>
										<div class="col-md-2">
