...
dataProcessor.prototype = {
        ...
        if (e) {
            ...
            if ("GET" == this._tMode) s.query({
                ...
                var h = this.getState(t),
                    ...
                    o = "",
                    c = "post";
                "inserted" == h ? o = this.serialize(e, t) : "deleted" == h ? (c = "DELETE", _ = _ + ("/" == _.slice(-1) ? "" : "/") + t) : (c = "PUT", o = this.serialize(e, t), _ = _ + ("/" == _.slice(-1) ? "" : "/") + t), _ = this._applyPayload(_), s.query({
                    url: _,
                    method: c,
                    headers: this._headers,
                    data: o,
        ...
        if (window.JSON) {
            ...
            if (s) {
                var n = s.action || this.getState(i) || "updated",
                    d = s.sid || i[0],
                    o = s.tid || i[0];
                return e.afterUpdateCallback(d, o, n, s), void e.finalizeUpdate()
            }
        }
	...
	function () {
	    ...
	    if (this._drag_mode) {
	        ...
	        if (this._is_pos_changed(this._drag_pos, t)) {
	            ...
	            if (scheduler.matrix && (o = scheduler.matrix[scheduler._mode]), o = o || {
	                x_step: 1,
	                x_unit: "day"
	            }, "move" == this._drag_mode) i = this._min_date.valueOf() + 6e4 * (t.y * this.config.time_step + 24 * t.x * 60 - (scheduler._move_pos_shift || 0)), !t.custom && this._table_view && (i += 1e3 * this.date.time_part(l.start_date)), i = this._correct_shift(i), t._ignores && this.config.preserve_length && this._table_view ? (i = scheduler._correct_drag_start_date(i), r = scheduler._correct_drag_end_date(i, this._drag_event._event_length)) : r = l.end_date.valueOf() - (l.start_date.valueOf() - i);
	            else {
	            ...
	            if ("move" == this._drag_mode && scheduler.config.limit_drag_out && (+v < +scheduler._min_date || +r > +scheduler._max_date)) {
	                if (+l.start_date < +scheduler._min_date || +l.end_date > +scheduler._max_date) v = new Date(l.start_date),
						r = new Date(l.end_date);
	                else {
	                    var m = r - v; +v < +scheduler._min_date ? (v = new Date(scheduler._min_date), t._ignores && this.config.preserve_length && this._table_view ? (v = new Date(scheduler._correct_drag_start_date(v)), o._start_correction && (v = new Date(v.valueOf() + o._start_correction)), r = new Date(1 * v + this._get_fictional_event_length(v, this._drag_event._event_length, o))) : r = new Date(+v + m)) : (r = new Date(scheduler._max_date), t._ignores && this.config.preserve_length && this._table_view ? (o._end_correction && (r = new Date(r.valueOf() - o._end_correction)), r = new Date(1 * r - this._get_fictional_event_length(r, 0, o, !0)), v = new Date(1 * r - this._get_fictional_event_length(r, this._drag_event._event_length, o, !0)), this._ignores_detected && (v = scheduler.date.add(v, o.x_step, o.x_unit), r = new Date(1 * r - this._get_fictional_event_length(r, 0, o, !0)), r = scheduler.date.add(r, o.x_step, o.x_unit))) : v = new Date(+r - m))
	                }
	                var f = new Date(r - 1)
	            }
	            ...
	            if (this._table_view || f.getDate() == v.getDate() && f.getHours() < this.config.last_hour || scheduler._allow_dnd)
	                if (l.start_date = v, l.end_date = new Date(r), this.config.update_render) {
	    ...
	    _call: function (e, t, i, r, s, a, n) {
	        ...
	        }), "GET" != e || this.cache || (t += (t.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (new Date).getTime() + "=1"), o.open(e, t, r), n)
	            for (var h in n) o.setRequestHeader(h, n[h]);
	        else "POST" == e.toUpperCase() || "PUT" == e || "DELETE" == e ? o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded") : "GET" == e && (i = null);
	    ...
	    date: {
	        month_full: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"],//January,February,March,April,May,June,July,August,September,October,November,December
	        month_short: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"],//"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"
	        day_full: ["日", "一", "二", "三", "四", "五", "六"],//Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday
	        day_short: ["日", "一", "二", "三", "四", "五", "六"]//"Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"
	    },
	    labels: {
	        dhx_cal_today_button: "今天",//Today
	        day_tab: "天",//Day
	        week_tab: "週",//Week
	        month_tab: "月",//Month
	        new_event: "新增行程",//New event
	        icon_save: "儲存",//Save
	        icon_cancel: "取消",//Cancel
	        icon_details: "Details",
	        icon_edit: "編輯",//Edit
	        icon_delete: "刪除",//Delete
	        confirm_closing: "",
	        confirm_deleting: "行程將被刪除，確定刪除?",//Event will be deleted permanently, are you sure?
	        section_description: "標題",//Description
	        section_time: "時間",//Time period
	...
	scheduler.templates = {}, scheduler.init_templates = function () {
	    ...
	    r(scheduler.templates, {
	        ...
	        tooltip_text: function (e, t, i) {
	            return "<b>行程:</b> " + i.text + "<br/><b>開始時間:</b> " + scheduler.templates.tooltip_date_format(e) + "<br/><b>結束時間:</b> " + scheduler.templates.tooltip_date_format(t);
	...
	function () {
	    ...
	    for (var i, r = [], s = [
	        ...
	        if (l._sday = g % n, !this._ignores[l._sday] || !l._timed) {
	            ...
	            if (l._sorder && t || (l._sorder = v), l._sday + l._length <= n) i = null, r.push(l), m[v] = l, a[l._sweek] = m.length - 1, l._first_chunk = _.first_chunk,
	    ...
	    if (!(e._sday < 0)) {
	        ...
	        if (r) {
	            ...
	            if (this._waiAria.eventAttr(e, g), this._rendered.push(g), r.appendChild(g), h = h + parseInt(r.style.left, 10) + i, this._edit_id == e.id) {
	                g.style.zIndex = 1, l = Math.max(l - 4, scheduler.xy.editor_width), g = document.createElement("div"), g.setAttribute("event_id", e.id), this._waiAria.eventAttr(e, g), this.set_xy(g, l, n - 20, h, a + (scheduler.xy.event_header_height || 14)),
	                ...
	                this.set_xy(v, l - 6, n - 26), v.style.cssText += ";margin:2px 2px 2px 2px;overflow:hidden;", g.appendChild(v), this._els.dhx_cal_data[0].appendChild(g), this._rendered.push(g), v.innerHTML = "<textarea class='dhx_cal_editor'>" + e.text + "</textarea>", this._quirks7 && (v.firstChild.style.height = n - 12 + "px"), this._editor = v.firstChild,
	    ...
	    return o && (k = "dhx_resize_denied " + k), A += '<div class="' + k + '" style=" width:' + y + "px;" + (o ? " margin-top:-1px;" : "") + g + f + '" ></div>', E.innerHTML = A, E
	    ...
	    parse_date: function (e, t, i) {
	        ...
	        var s = r[0].substr(0, 4),
				a = parseInt(r[0].substr(4, 2), 10) - 1,
				n = r[0].substr(6, 2);
	    ...
	    time: {
	        render: function (e) {
	            ...
	            for (var n = "", d = 0; d < t.length; d++) {
	                ...
	                if (h) {
	                    var v = scheduler._waiAria.lightboxSelectAttrString(o),
	        ...
	        if ("string" != typeof i) {
	            ...
	            return this.each(function () {
	                if (this && this.getAttribute && !this.getAttribute("dhxscheduler")) {
	                    ...
	                    this.getElementsByTagName("div").length || (this.innerHTML = '<div class="dhx_cal_navline"><div class="dhx_cal_prev_button">&nbsp;</div><div class="dhx_cal_next_button">&nbsp;</div><div class="dhx_cal_today_button"></div><div class="dhx_cal_date"></div><div class="dhx_cal_tab" name="day_tab" style="right:204px;"></div><div class="dhx_cal_tab" name="week_tab" style="right:140px;"></div><div class="dhx_cal_tab" name="month_tab" style="right:76px;"></div></div><div class="dhx_cal_header"></div><div class="dhx_cal_data"></div>', this.className += " dhx_cal_container"), scheduler.init(this, scheduler.config.date, scheduler.config.mode), i.data && scheduler.parse(i.data), r.push(scheduler)
	                }
	            }), 1 === r.length ? r[0] : r
	        }
