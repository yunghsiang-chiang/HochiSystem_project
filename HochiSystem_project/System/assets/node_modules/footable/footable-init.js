...
$(window).on('load', function() {
	...
	// Accordion
	// -----------------------------------------------------------------
	$('#demo-foo-accordion1').footable().on('footable_row_expanded', function (e) {
		$('#demo-foo-accordion1 tbody tr.footable-detail-show').not(e.row).each(function () {
			$('#demo-foo-accordion1').data('footable').toggleDetail(this);
		});
	});
